        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
          <div>
            ...
            <p className="text-gray-500 mt-1">
              {leads.length} total lead{leads.length !== 1 ? "s" : ""} delivered to you
            </p>
          </div>
        </div>
              ...
              >
                ...
                >
                  ...
                  <div className="flex items-center gap-3 shrink-0">
                    ...
                    >
                      {lead.matchStatus === "delivered" ? "New" : lead.matchStatus.charAt(0).toUpperCase() + lead.matchStatus.slice(1)}
                    </span>
                    <svg
                  ...
                  <div className="px-6 pb-5 border-t border-gray-100">
                    ...
                    <div className="flex gap-3 mt-4">
                      {lead.matchStatus !== "contacted" && (
                        <button
                          onClick={() =>
                            updateStatus(lead.matchId, "contacted")
                          }
